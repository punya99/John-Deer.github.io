    ...
    return {
        ...
        load: function() {
            jQuery("select").length && jQuery("select").selectpicker(), jQuery("input[name='demo_vertical2']").TouchSpin({
                ...
                }(), jQuery("body").append('\x3c!-- Go to www.addthis.com/dashboard to customize your tools --\x3e')
        },
        resize: function() {
